...
linker.cmd: package/cfg/release_pem4f.xdl
	$(SED) 's"^\"\(package/cfg/release_pem4fcfg.cmd\)\"$""\"/Volumes/Storage/shared/mdannyk/ti/tirtos_builds_CC1352R1_LAUNCHXL_release_ccs/Debug/configPkg/\1\""' package/cfg/release_pem4f.xdl > $@
